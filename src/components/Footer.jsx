  ...
  return (
      <footer className="border-t border-t-zinc-200 shadow-sm text-center py-6">
         ...
         <ul className='flex justify-center items-center gap-6 mt-6 text-zinc-700'>
            <li><a href="#"><Twitter size={26} className='hover:text-zinc-800'/></a></li>
            <li><a href="#"><Github size={26} className='hover:text-zinc-800'/></a></li>
            <li><a href="#"><Instagram size={26} className='hover:text-zinc-800'/></a></li>
         </ul>
      </footer>
  )
}
